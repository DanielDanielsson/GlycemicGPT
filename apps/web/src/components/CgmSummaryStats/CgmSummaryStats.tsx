...
import { TimeInRangePanelContent } from "@/components/TimeInRangePanel";
import type { CgmSummaryStatsProps } from "./CgmSummaryStats.types";
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 border-t border-border-default sm:grid-cols-2">
            ...
            metrics={[
              {
                ...
                label: "Avg Glucose",
                value: isReasonableGlucose(stats.mean_glucose)
              ...
              },
              {
                ...
                label: "Min Glucose",
                value: isReasonableGlucose(stats.min_glucose)
                  ? formatGlucose(stats.min_glucose, unit)
                  : "--",
                unit: unitLabel(unit),
              ...
              },
              {
                ...
                label: "Max Glucose",
                value: isReasonableGlucose(stats.max_glucose)
                  ? formatGlucose(stats.max_glucose, unit)
                  : "--",
                unit: unitLabel(unit),
          ...
          <StatRow
            ...
            value={
              isValidStdDev(stats.std_dev)
                ? formatGlucose(stats.std_dev, unit)
                : "--"
            }
