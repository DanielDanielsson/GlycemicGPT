...
import type { TimeInRangeBarProps, TimePeriod } from "./TimeInRangeBar.types";
...
export function TimeInRangeBar({
  ...
  return (
    ...
    >
      ...
      <div
        className={
          shouldAnimate ? "animate-tir-bar-expand origin-left" : undefined
        }
      >
        {currentBar}
        {previousBar}
      ...
      <p className="text-foreground-secondary font_metric_caption mt-3 text-center">
        ...
        {previousReadingsCount != null && ` (prev: ${previousReadingsCount})`}
      </p>
    </div>
  );
}
